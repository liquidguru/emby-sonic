# deploy.ps1 — push emby-sonic to coordinator-host
# Run from dev-pc: .\deploy.ps1

$BEE = "liqui@192.168.1.50"
$REMOTE = "C:/emby-sonic"

Write-Host "Syncing to coordinator-host:$REMOTE ..."
...
if (Get-Command wsl -ErrorAction SilentlyContinue) {
    ...
    Write-Host "WSL not available. Use scp or map coordinator-host drive manually."
    Write-Host "scp -r C:\Users\liqui\dev\emby-sonic ${BEE}:C:/emby-sonic"
}

Write-Host ""
Write-Host "On coordinator-host, first-time setup:"
