...
- **M5.5 — Coordinator Sonic Adventure dedupe (2026-06-20, deployed +
  ...
  `py -3.14 -m compileall analysis api`; liquidBee was then pulled/restarted
...
- **M5.15 — Plugin auto-scan fix (2026-06-20, plugin v0.4.0.0, built):** the
  ...
  (verified live on liquidBee: **401 Unauthorized**). So new imports were only
...
- **M5.17 — Artist Mix Creator (6th station) (2026-06-24, built + Pixel 8 Pro
  ...
  feature name. Deployed to liquidBee via push→`git pull`→coordinator restart;
